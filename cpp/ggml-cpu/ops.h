...
void wsp_ggml_compute_forward_lightning_indexer(const struct wsp_ggml_compute_params * params, struct wsp_ggml_tensor * dst);
void wsp_ggml_compute_forward_dsv4_hc_comb(const struct wsp_ggml_compute_params * params, struct wsp_ggml_tensor * dst);
void wsp_ggml_compute_forward_dsv4_hc_pre(const struct wsp_ggml_compute_params * params, struct wsp_ggml_tensor * dst);
void wsp_ggml_compute_forward_dsv4_hc_post(const struct wsp_ggml_compute_params * params, struct wsp_ggml_tensor * dst);
