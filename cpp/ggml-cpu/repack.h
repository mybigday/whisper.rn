...
static_assert(sizeof(block_q5_Kx8) == sizeof(wsp_ggml_half) * 16 + K_SCALE_SIZE * 8 + QK_K * 5,
...
static_assert(sizeof(block_q6_Kx8) == sizeof(wsp_ggml_half) * 8 + QK_K / 16 * 8 + 3 * QK_K / 4 * 8,
